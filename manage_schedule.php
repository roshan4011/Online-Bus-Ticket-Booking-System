	...
	<form id="manage_schedule">
		<div class="col-md-12">
			...
			<div class="form-group mb-2">
				...
				<input type="text" class="datetimepicker form-control" id="eta" name="eta" value="<?php echo isset($meta['eta']) ? date('M d, Y h:i A', strtotime($meta['eta'])) : '' ?>">
			</div>
			<div class="form-group mb-2">
